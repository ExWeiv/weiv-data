...
async function queryReferenced(collectionId, targetCollectionId, itemId, propertyName, queryOptions, options) {
    try {
        ...
        const referencedClass = new query_referenced_result_1.WeivDataQueryReferencedResult(collectionId, targetCollectionId, editedItemId, propertyName, queryOptions, options || { suppressAuth: false, suppressHooks: false, cleanupAfter: false, consistentRead: false });
